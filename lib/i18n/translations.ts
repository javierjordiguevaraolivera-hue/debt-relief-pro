...
export const translations = {
  en: {
    ...
    home: {
      eyebrow: "Free debt relief assessment",
      heroTitle: "Debt relief designed to help you move forward.",
      heroText:
        "See whether a structured debt settlement path may fit your unsecured debt, your budget, and your next step.",
      primaryCta: "Start free assessment",
      secondaryCta: "Call a specialist",
      trustNote: "No obligation. No upfront program fees. Checking does not affect your credit score.",
      estimateTitle: "Get your free savings estimate",
      ...
      reviewStats: [
        ...
        { value: "24-48", label: "Typical program months" },
        { value: "$10k+", label: "Common enrolled debt" },
      ],
      benefitsTitle: "What debt relief can do for you",
      benefits: [
        {
          title: "Lower monthly pressure",
          text: "Explore a structured plan aimed at making unsecured debt feel more manageable.",
        },
        {
          title: "A path built around your budget",
          text: "Review your debt amount, hardship, and goals before continuing to a partner.",
        },
        {
          title: "No upfront program fees",
          text: "Debt settlement programs are generally performance-based and vary by provider.",
        },
      ],
      processTitle: "How the program works",
      steps: [
        "Start with a free assessment and tell us what type of debt you want to resolve.",
        "Review whether your situation may qualify for a partner debt relief option.",
        "Continue to the affiliate partner to discuss a personalized next step.",
      ],
      fitTitle: "Debt relief may be a fit if you",
      fitItems: [
        "Have $10,000 or more in unsecured debt",
        "Are struggling with credit card or personal loan payments",
        "Want an alternative to making minimum payments for years",
        "Need a clear plan before speaking with a provider",
      ],
  ...
  es: {
    ...
    home: {
      eyebrow: "Evaluacion gratuita de alivio de deuda",
      heroTitle: "Alivio de deuda pensado para ayudarte a avanzar.",
      heroText:
        "Revisa si un camino estructurado de negociacion puede encajar con tus deudas sin garantia, tu presupuesto y tu siguiente paso.",
      primaryCta: "Empezar evaluacion gratis",
      secondaryCta: "Llamar a un especialista",
      trustNote: "Sin obligacion. Sin cargos iniciales del programa. Revisar no afecta tu puntaje de credito.",
      estimateTitle: "Obten tu estimado gratis",
      ...
      reviewStats: [
        ...
        { value: "24-48", label: "Meses tipicos del programa" },
        { value: "$10k+", label: "Deuda comun inscrita" },
      ],
      benefitsTitle: "Que puede hacer el alivio de deuda por ti",
      benefits: [
        {
          title: "Menos presion mensual",
          text: "Explora un plan estructurado para que la deuda sin garantia se sienta mas manejable.",
        },
        {
          title: "Un camino segun tu presupuesto",
          text: "Revisa tu deuda, dificultad economica y metas antes de continuar con un socio.",
        },
        {
          title: "Sin cargos iniciales del programa",
          text: "Los programas de negociacion de deuda suelen basarse en resultados y varian por proveedor.",
        },
      ],
      processTitle: "Como funciona el programa",
      steps: [
        "Empieza con una evaluacion gratis y dinos que tipo de deuda quieres resolver.",
        "Revisa si tu situacion puede calificar para una opcion de alivio con un socio.",
        "Continua con el socio afiliado para hablar de un siguiente paso personalizado.",
      ],
      fitTitle: "El alivio de deuda puede ser para ti si",
      fitItems: [
        "Tienes $10,000 o mas en deudas sin garantia",
        "Tienes dificultad pagando tarjetas de credito o prestamos personales",
        "Quieres una alternativa a pagar minimos durante anos",
      ...
      testimonials: [
        {
          quote:
            "El proceso hizo que las opciones fueran mas faciles de entender antes de hablar con alguien.",
          name: "Visitante verificado",
        },
        {
          quote:
            "Me gusto ver lo basico en lenguaje claro y saber que pasaria despues.",
          name: "Consumidor pre-calificado",
        },
      ],
      ctaTitle: "Listo para reducir el estres de tus deudas?",
      ctaText:
        "Empieza con una evaluacion breve y continua cuando estes listo para revisar tus opciones.",
      blogTitle: "Articulos sobre alivio de deuda",
      blogEmpty: "Los posts apareceran aqui cuando se publiquen en Sanity.",
    },
    apply: {
      title: "Aplica para alivio de deuda",
      description:
        "Responde unas preguntas y continua con un socio confiable para el siguiente paso.",
      amountLabel: "Deuda sin garantia estimada",
      stateLabel: "Estado",
      hardshipLabel: "Dificultad actual",
      hardshipPlaceholder: "Perdida de empleo, ingresos reducidos, gastos medicos u otra razon",
      button: "Continuar con el socio",
      disclosure:
        "Al continuar, entiendes que puedes ser redirigido a un socio afiliado externo. Este sitio no ofrece asesoria legal, fiscal ni crediticia.",
    },
    blog: {
      title: "Blog de alivio de deuda",
      description:
        "Guias educativas sobre opciones de alivio de deuda, requisitos y proximos pasos.",
      readMore: "Leer articulo",
      back: "Volver al blog",
      empty: "Aun no hay posts publicados.",
    },
    footer: {
      disclosure:
        "Este sitio web es un publicador afiliado. La informacion es educativa y no garantiza aprobacion, ahorros ni disponibilidad de programas.",
      privacy: "Privacidad",
      terms: "Terminos",
    },
  },
